...
urlpatterns = [
    ...
    path('api/professor/status/', views.api_get_professor_status, name='api_get_professor_status'),
    path('api/professor/status/set/', views.api_set_professor_status, name='api_set_professor_status'),
