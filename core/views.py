...
def student_dashboard(request):
    """
    Display student view of all professors' schedules with filter functionality.
    Only shows schedules with 'Available' status by default.
    """
    schedules = Schedule.objects.select_related('professor').filter(
        status='Available'
